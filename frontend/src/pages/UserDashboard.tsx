...
const UserDashboard: React.FC = () => {
  ...
  const getCurrentUser = async (user_id) => {
    const res = await axios.get(`${API_URL}/api/user/${user_id}`);
    return res.data;
  };
  ...
  const getCurrentUserShipments = async (user_id) => {
    const res = await axios.get(`${API_URL}/api/user/${user_id}/shipments`);
    return res.data;
  ...
  useEffect(() => {
    ...
    getCurrentUserShipments(user_id)
        .then((shipmentData) => {
        ...
        shipmentData.forEach((shipment) => {
            ...
            if (shipment.status === "in_transit") inTransitCount++;
   ...
   const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (window.confirm("Are you sure you want to update this user?")) {
      try {
        ...
        await axios.put(`${API_URL}/api/user/update/${user_id}`, formData);
